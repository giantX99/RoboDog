...
#include "i2cpwm_controller/msg/detail/position_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = i2cpwm_controller::msg::PositionArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const i2cpwm_controller::msg::PositionArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<i2cpwm_controller::msg::PositionArray *>(
    untyped_ros_message);
...
{
  return &i2cpwm_controller::msg::typesupport_fastrtps_cpp::_PositionArray__handle;
}
