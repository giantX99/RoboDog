...
#include "i2cpwm_controller/msg/detail/servo_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const i2cpwm_controller::msg::Servo &,
...
cdr_serialize(
  const i2cpwm_controller::msg::ServoArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  i2cpwm_controller::msg::ServoArray & ros_message)
{
  // Member: servos
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: servos
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        i2cpwm_controller::msg::typesupport_fastrtps_cpp::max_serialized_size_Servo(
  ...
  if (is_plain) {
    ...
    using DataType = i2cpwm_controller::msg::ServoArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const i2cpwm_controller::msg::ServoArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<i2cpwm_controller::msg::ServoArray *>(
    untyped_ros_message);
...
{
  return &i2cpwm_controller::msg::typesupport_fastrtps_cpp::_ServoArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, i2cpwm_controller, msg, ServoArray)() {
  return &i2cpwm_controller::msg::typesupport_fastrtps_cpp::_ServoArray__handle;
}
