...
static const _PositionArray_type_support_symbol_names_t _PositionArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, i2cpwm_controller, msg, PositionArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, i2cpwm_controller, msg, PositionArray)),
  }
};
...
{
  return &::i2cpwm_controller::msg::rosidl_typesupport_cpp::PositionArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, i2cpwm_controller, msg, PositionArray)() {
  return get_message_type_support_handle<i2cpwm_controller::msg::PositionArray>();
}
