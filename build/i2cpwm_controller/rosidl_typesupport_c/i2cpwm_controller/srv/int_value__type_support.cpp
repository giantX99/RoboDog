...
static const _IntValue_Request_type_support_symbol_names_t _IntValue_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i2cpwm_controller, srv, IntValue_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, i2cpwm_controller, srv, IntValue_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, i2cpwm_controller, srv, IntValue_Request)() {
  return &::i2cpwm_controller::srv::rosidl_typesupport_c::IntValue_Request_message_type_support_handle;
}
...
static const _IntValue_Response_type_support_symbol_names_t _IntValue_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i2cpwm_controller, srv, IntValue_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, i2cpwm_controller, srv, IntValue_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, i2cpwm_controller, srv, IntValue_Response)() {
  return &::i2cpwm_controller::srv::rosidl_typesupport_c::IntValue_Response_message_type_support_handle;
}
...
static const _IntValue_type_support_symbol_names_t _IntValue_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i2cpwm_controller, srv, IntValue)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, i2cpwm_controller, srv, IntValue)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, i2cpwm_controller, srv, IntValue)() {
  return &::i2cpwm_controller::srv::rosidl_typesupport_c::IntValue_service_type_support_handle;
}
