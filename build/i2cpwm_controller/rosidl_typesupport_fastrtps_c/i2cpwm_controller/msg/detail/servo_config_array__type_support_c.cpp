...
#include "i2cpwm_controller/msg/detail/servo_config_array__rosidl_typesupport_fastrtps_c.h"
...
using _ServoConfigArray__ros_msg_type = i2cpwm_controller__msg__ServoConfigArray;
...
size_t get_serialized_size_i2cpwm_controller__msg__ServoConfigArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ServoConfigArray__ros_msg_type * ros_message = static_cast<const _ServoConfigArray__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ServoConfigArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_i2cpwm_controller__msg__ServoConfigArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_i2cpwm_controller
size_t max_serialized_size_i2cpwm_controller__msg__ServoConfigArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = i2cpwm_controller__msg__ServoConfigArray;
    is_plain =
      (
...
static size_t _ServoConfigArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_i2cpwm_controller__msg__ServoConfigArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i2cpwm_controller, msg, ServoConfigArray)() {
