...
#include "i2cpwm_controller/msg/detail/position__rosidl_typesupport_fastrtps_c.h"
...
using _Position__ros_msg_type = i2cpwm_controller__msg__Position;
...
static uint32_t _Position__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_i2cpwm_controller__msg__Position(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = i2cpwm_controller__msg__Position;
    is_plain =
      (
...
static size_t _Position__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_i2cpwm_controller__msg__Position(
