...
bool i2cpwm_controller__msg__position_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("i2cpwm_controller.msg._position_array.PositionArray", full_classname_dest, 51) == 0);
  }
  i2cpwm_controller__msg__PositionArray * ros_message = _ros_message;
  {  // servos
...
PyObject * i2cpwm_controller__msg__position_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("i2cpwm_controller.msg._position_array");
