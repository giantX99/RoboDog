...
#include "i2cpwm_controller/msg/detail/servo__rosidl_typesupport_fastrtps_c.h"
...
using _Servo__ros_msg_type = i2cpwm_controller__msg__Servo;
...
static uint32_t _Servo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_i2cpwm_controller__msg__Servo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = i2cpwm_controller__msg__Servo;
    is_plain =
      (
...
static size_t _Servo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_i2cpwm_controller__msg__Servo(
