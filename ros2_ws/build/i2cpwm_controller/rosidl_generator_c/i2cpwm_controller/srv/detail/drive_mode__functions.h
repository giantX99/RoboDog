...
#ifndef I2CPWM_CONTROLLER__SRV__DETAIL__DRIVE_MODE__FUNCTIONS_H_
#define I2CPWM_CONTROLLER__SRV__DETAIL__DRIVE_MODE__FUNCTIONS_H_
 ...
 * calls
 * i2cpwm_controller__srv__DriveMode_Request__init().
...
/**
 * It calls
 * i2cpwm_controller__srv__DriveMode_Request__fini()
 ...
 * i2cpwm_controller__srv__DriveMode_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * i2cpwm_controller__srv__DriveMode_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * i2cpwm_controller__srv__DriveMode_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_i2cpwm_controller
...
/**
 * It calls
 * i2cpwm_controller__srv__DriveMode_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_i2cpwm_controller
...
/**
 * It allocates the memory for the array and calls
 * i2cpwm_controller__srv__DriveMode_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_i2cpwm_controller
...
/**
 * It calls
 * i2cpwm_controller__srv__DriveMode_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // I2CPWM_CONTROLLER__SRV__DETAIL__DRIVE_MODE__FUNCTIONS_H_
