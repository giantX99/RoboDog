...
static const _IntValue_Request_type_support_symbol_names_t _IntValue_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, i2cpwm_controller, srv, IntValue_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, i2cpwm_controller, srv, IntValue_Request)),
  }
};
...
{
  return &::i2cpwm_controller::srv::rosidl_typesupport_cpp::IntValue_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, i2cpwm_controller, srv, IntValue_Request)() {
  return get_message_type_support_handle<i2cpwm_controller::srv::IntValue_Request>();
}
...
static const _IntValue_Response_type_support_symbol_names_t _IntValue_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, i2cpwm_controller, srv, IntValue_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, i2cpwm_controller, srv, IntValue_Response)),
  }
};
...
{
  return &::i2cpwm_controller::srv::rosidl_typesupport_cpp::IntValue_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, i2cpwm_controller, srv, IntValue_Response)() {
  return get_message_type_support_handle<i2cpwm_controller::srv::IntValue_Response>();
}
...
static const _IntValue_type_support_symbol_names_t _IntValue_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, i2cpwm_controller, srv, IntValue)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, i2cpwm_controller, srv, IntValue)),
  }
};
...
{
  return &::i2cpwm_controller::srv::rosidl_typesupport_cpp::IntValue_service_type_support_handle;
}
