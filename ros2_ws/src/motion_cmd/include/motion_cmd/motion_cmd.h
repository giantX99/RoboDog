...
class SpotMicroMotionCmd
{
 public:
  ...
  std::shared_ptr<rclcpp::Node> nh_; // Defining the ros NodeHandle variable for registrating the same with the master
 ...
 private:
  ...
  // std::shared_ptr<rclcpp::Node> pnh_; // Private version of node handle
